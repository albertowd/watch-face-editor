<script src="./week-day-progress.js" />
<style scoped src="./week-day-progress.css"></style>
<template>
  <v-card outlined>
    <v-card-title>
      <v-layout>
        ...
        <input
          ref="pngInput"
          accept=".png"
          class="editor-date-week-day-progress-icon-hidden"
          multiple
          type="file"
          @change="onFilePicked"
        />
    ...
    <v-expand-transition>
      <v-card-text v-show="expanded">
        ...
        <v-tabs v-model="tab" grow>
          <v-tab>{{ tWeekDay.mon }}</v-tab>
          <v-tab>{{ tWeekDay.tue }}</v-tab>
          <v-tab>{{ tWeekDay.wed }}</v-tab>
          <v-tab>{{ tWeekDay.thu }}</v-tab>
          <v-tab>{{ tWeekDay.fri }}</v-tab>
          <v-tab>{{ tWeekDay.sat }}</v-tab>
          <v-tab>{{ tWeekDay.sun }}</v-tab>
        </v-tabs>
        <v-slider
          v-model="x"
          label="X:"
